...
public class LogoutActivity {
    ...
    public void logoutUserWithHours(String userID, int userRow, LocalTime totalHoursTime, String totalTimeFromDifference) {
        ...
        try {
            tempTotalDayTime = LocalTime.parse(totalTimeFromDifference).plusHours(prevDayTime.getHour()).plusMinutes(prevDayTime.getMinute()).plusSeconds(prevDayTime.getSecond());
